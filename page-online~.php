			...
			<div class="cp_content flip-page">
				...
				<!-- start 01 online -->
					<section id="online-01" class="bcg-brown">
						...
						<h3 class="coursepage-title-age">もっと自由に、もっと学べる、</h3>
							<p class="coursepage-title-copy">おうちでKids UP　オンライン</p>


							<h3 class="coursepage-title-age">More freedom, More learning,</h3>
							<p class="coursepage-title-copy">Kids UP Online at home</p>
