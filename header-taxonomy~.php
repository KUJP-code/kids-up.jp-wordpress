...
<title><?php $terms = get_the_terms($post->ID, 'column-cat'); if ($terms) : foreach ($terms as $term) { echo $term->name; } endif; ?>一覧 | 学童保育型 英語・英会話スクール Kids UP （キッズアップ）</title>
...
<script src="<?php echo get_template_directory_uri(); ?>/js/togglemenu.js" type="text/javascript"></script>
...
<meta property="og:title" content="<?php $terms = get_the_terms($post->ID, 'column-cat'); if ($terms) : foreach ($terms as $term) { echo $term->name; } endif; ?>一覧 | 学童保育型 英語・英会話スクール Kids UP （キッズアップ）" />
...
<!-- End Google Tag Manager (noscript) -->
	<div class="cp_cont">
		...
		<header>
			<section id="top-header" class="global_nav flip-page">
			  <div class="top-header-left">
				<p class="logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img class="logo_pc" src="<?php echo get_template_directory_uri(); ?>/img/logo.svg" alt="学童保育型　英会話スクール・幼児クラス - Kids UP" width="100%" height="auto"><img class="logo_mb" src="<?php echo get_template_directory_uri(); ?>/img/logo.svg" alt="学童保育型　英会話スクール・幼児クラス - Kids UP" width="157" height="50"></a></p>
			  </div>
			  <div class="top-header-right">
				<div id="nav_cta">
					<div class="only_pc"><a class="nav_school" href="<?php echo esc_url( home_url( '/' ) ); ?>school">お近くの教室を探す</a></div>
					<div class="only_pc"><a class="nav_tel" href="tel:0120-378-056">電話でお問合せ</a></div>
					<div class="only_pc"><a class="nav_trial" href="<?php echo esc_url( home_url( '/' ) ); ?>entry">無料体験お申し込み</a></div>
				</div>
				<div id="nav_toggle">
					<div>
						<span></span>
				...
				<nav id="nav-top">
					<div class="menu-area">
					    <div class="menu-area-left">
							<div id="nav_cta">
								<div><a class="only_pc_only" style="border: none; margin-bottom: 50px;" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img class="logo_pc" src="<?php echo get_template_directory_uri(); ?>/img/footer-logo.svg" alt="学童保育型　英会話スクール・幼児クラス - Kids UP" width="100%" height="auto"></a></div>
								<div><a class="nav_trial btn_normal" href="<?php echo esc_url( home_url( '/' ) ); ?>entry">無料体験お申し込み</a></div>
								<div><a class="nav_tel btn_normal" href="tel:0120-378-056">電話でお問い合せ</a></div>
								<div><a class="nav_school btn_normal" href="<?php echo esc_url( home_url( '/' ) ); ?>inquiry">お問い合わせ</a></div>
								<div><a class="only_mb_only" style="border: none; margin-bottom: 50px;" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img class="logo_mb" src="<?php echo get_template_directory_uri(); ?>/img/footer-logo.svg" alt="学童保育型　英会話スクール・幼児クラス - Kids UP" width="100%" height="auto"></a></div>
							</div>
						</div>
