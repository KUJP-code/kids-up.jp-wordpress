...
<title><?php $cat = get_the_category(); $cat_name = $cat[0] -> name; $cat_slug = $cat[0] -> slug; echo esc_html($cat_name); ?>一覧 | 学童保育型 英語・英会話スクール Kids UP （キッズアップ）</title>
...
<meta property="og:title" content="<?php $cat = get_the_category(); $cat_name = $cat[0] -> name; $cat_slug = $cat[0] -> slug; echo esc_html($cat_name); ?>一覧 | 学童保育型 英語・英会話スクール Kids UP （キッズアップ）" />
