		...
		<header>
			<section id="top-header" class="global_nav">
			  <div class="top-header-left">
				<p class="logo"><a href="<?php echo esc_url(
        home_url("/"),
    ); ?>"><img class="logo_pc" src="<?php echo get_template_directory_uri(); ?>/img/logo.svg" alt="学童保育型　英会話スクール・幼児クラス - Kids UP" width="100%" height="auto"><img class="logo_mb" src="<?php echo get_template_directory_uri(); ?>/img/logo.svg" alt="学童保育型　英会話スクール・幼児クラス - Kids UP" width="157" height="50"></a></p>
			  </div>
