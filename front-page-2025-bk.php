...
<section class="top-slide">
		<div class="only_pc_only">
			<?php
			echo do_shortcode('[smartslider3 slider="2"]');
			?>
		</div>
		<div class="only_mb_only">
			<?php
	...
	<div class="top_section1_left">
		<div class="top_sec1_l_content">
			<div class="top_title_wrapper">
				<p class="top_title main_title" style="color: #000;">FEATURES</p>
				<h2 class="top_title" style="color: #000;"><span class="sub_title">Kids UPの特長について</span></h2>
			</div>
    ...
    <div class="top_sec2_content">
      <div class="top_sec2_content_detail">
        <a href="https://vimeo.com/1036642872" data-lity="data-lity">
          <img
            src="https://kids-up.jp/wp-admin/images/speech-winners-2024/front-page/winner-front-land.webp"
        /></a>
      ...
      <div class="top_sec2_content_detail">
        <a href="https://vimeo.com/1036642995" data-lity="data-lity"
          ><img
            src="https://kids-up.jp/wp-admin/images/speech-winners-2024/front-page/winner-front-sky.webp"
        /></a>
        <div class="name_section">
      ...
      <div class="top_sec2_content_detail">
        <a href="https://vimeo.com/1036642805" data-lity="data-lity"
          ><img
            src="https://kids-up.jp/wp-admin/images/speech-winners-2024/front-page/winner-front-galaxy.webp"
        /></a>
        <div class="name_section">
      ...
      <div class="top_sec2_content_detail">
        <a href="https://vimeo.com/1036643079" data-lity="data-lity"
          ><img
            src="https://kids-up.jp/wp-admin/images/speech-winners-2024/front-page/winner-front-specialist.webp"
        /></a>
        <div class="name_section">
          ...
          <span>Keiichiroさん　四谷校</span>
        </div>
        <div class="top_sec2_wrapper">
          <a
            href="https://vimeo.com/1036643079"
            data-lity="data-lity"
            ><span class="btntransform">動画を見る</span></a
          >
        </div>
	...
	<li class="top_sec4_content slide-bottom show">
		...
		<div class="top_sec4_content_right">
			<div class="top_sec4_content_detail">
				...
				<div class="btn_main btn_main_orange">
					<a href="course/kindy" class="btn bgskew"><span class="btn_title">幼児コース詳細</span></a>
				</div>
			</div>
		</div>
	</li>
	<li class="top_sec4_content slide-bottom show">
		...
		<div class="top_sec4_content_right">
			<div class="top_sec4_content_detail">
				...
				<div class="btn_main btn_main_orange">
					<a href="course/elementary" class="btn bgskew"><span class="btn_title">学童コース詳細</span></a>
				</div>
			</div>
		</div>
	</li>
...
<section id="top_section7" class="slide-bottom show">
	<div class="top_title_wrapper">
		<p class="top_title main_title top_title_black">SEASONAL EVENT</p>
		<h2 class="top_title"><span class="sub_title top_title_black">シーズナルイベント</span></h2>
	</div>	
	<p class="p_normal">夏休みや冬休みなどの長期休みは、Kids UPでプチ留学！短期スクールは会員以外のお子様もご参加いただけるので、お試しにもピッタリです。<br>ハロウィンやクリスマスなどの季節のイベントや、年に一度のスピーチコンテストも開催しています。</p>
	<div class="slider-wide">
		<?php
		$cat_posts = get_posts(array(
			'post_type' => 'post',
			'category_name' => 'seasonal-cat',
			'posts_per_page' => 9,
			'orderby' => 'date',
			'order' => 'DESC'
		));
		...
		<figure>
			...
			<h5 class="seasonal-title"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h5>
		</figure>
		<!-- ROOP END -->
...
<div class="col2_wrapper columnnews-wrapper">
	<div class="col2_contents">
		<section id="top_section9" class="slide-bottom show">
			<div class="top_title_wrapper">
				<p class="top_title main_title top_title_black">NEWS</p>
				<h2 class="top_title"><span class="sub_title top_title_black">お知らせ</span></h2>
			</div>	
			<p class="p_normal">無料体験レッスンやイベント、レッスン情報などをお届けしています。</p>
			<div class="slider-wide1">
				<?php
				$cat_posts = get_posts(array(
					'post_type' => 'post',
					'category_name' => 'news-cat',
					'posts_per_page' => 3,
					'orderby' => 'date',
					'order' => 'DESC'
				));
				...
				<figure>
					<a class="thumnail-area" href="<?php the_permalink() ?>" style="background-image: url(<?php echo wp_get_attachment_url( get_post_thumbnail_id() ); ?>)"></a>
					<div class="cattime-wrapper"><p class="cat_area"><?php $cat = get_the_category(); $cat = $cat[0]; { echo $cat->cat_name; } ?></p><time class="time_area"><?php the_time('Y/m/d') ?></time><a href="<?php the_permalink() ?>" class="btn btn--circle btn--circle-c btn--shadow"><i class="fas fa-arrow-right"></i></a></div>
			...
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>category/news-cat" class="btn_normal btn_orange"><span class="btn_trial">ニュース一覧</span></a>
		</section><!-- end #top_section9-->
	</div><!-- end .col2_contents-->
	<div class="col2_contents">
		<section id="top_section8" class="slide-bottom show">
			<div class="top_title_wrapper">
				<p class="top_title main_title top_title_black">COLUMN</p>
				<h2 class="top_title"><span class="sub_title top_title_black">コラム</span></h2>
			</div>	
			<p class="p_normal">英語教育に役立つ情報や、英検・受験、留学など、英語にまつわる情報をお届けしています。</p>
			<div class="slider-wide1">
				<?php
				$cat_posts = get_posts(array(
					'post_type' => 'column',
			...
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>column/" class="btn_normal btn_orange"><span class="btn_trial">コラム一覧</span></a>
		</section><!-- end #top_section8-->
	</div><!-- end .col2_contents-->
	
</div><!-- end .col2_wrapper-->
